-- Create function to handle session notifications
...
BEGIN
  ...
  CASE p_notification_type
    ...
    WHEN 'no_show' THEN
      notification_title := 'Session Missed';
      notification_message := 'You missed your scheduled training session. Please reschedule when convenient.';
    ELSE
...
-- Add comment
COMMENT ON FUNCTION create_session_notification IS 'Creates session notifications for training sessions with appropriate messages based on notification type';
