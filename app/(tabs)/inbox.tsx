...
const messages = [
  ...
  },
  {
    ...
    message:
      "Don't forget about your scheduled Full Body Strength session at 6 PM.",
    time: '4 hours ago',
    read: false,
    icon: Clock,
    color: '#6366F1',
  ...
  },
  {
    ...
    message:
      'Sarah completed a 45-minute yoga session. Send her some encouragement!',
    time: '3 days ago',
    read: true,
    icon: Heart,
    color: '#EC4899',
...
export default function InboxView() {
  ...
  if (userRole === 'leads') {
    return (
      <RestrictedAccess message="You do not have access to this section." />
    );
  }
  ...
  const filters = [
    ...
    { id: 'unread', label: 'Unread', count: unreadCount },
    {
      id: 'motivation',
      label: 'Motivation',
      count: messages.filter((m) => m.type === 'motivation').length,
    },
    {
      id: 'reminders',
      label: 'Reminders',
